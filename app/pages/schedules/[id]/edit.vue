...
async function loadData() {
    ...
    try {
        const [accountsData, categoriesData, payeesData, projectsData, scheduleData] = await Promise.all([
            ...
            $fetch<{ schedule: any }>(`/api/schedules/${scheduleId}`)
        ])
        ...
        transactionType.value = s.transactionType
        form.value = {
            title: s.title,
            amount: Math.abs(s.amountFrom),
            ...
            nextTransactionDate: formatDateForInput(s.nextTransactionDate),
